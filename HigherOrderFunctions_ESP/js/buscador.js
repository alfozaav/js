...
marca.addEventListener('input', e => {
    ...
    //  Manda a llamar la función de filtrar autos
    filtrarAutos();
})
...
function noResultuado() {
    limpiarHTML();
    const noResultuado = document.createElement('div');
    noResultuado.classList.add('alerta', 'error');
    noResultuado.appendChild(document.createTextNode('No hay Resultados'));
    document.querySelector('#resultado').appendChild(noResultuado);
}
